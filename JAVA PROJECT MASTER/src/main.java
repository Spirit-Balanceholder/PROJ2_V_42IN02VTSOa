		...
		btnTest.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent evt)
			{
				...
				try
				{
					...
					d.addWhere("StatusID", "1");
					d.addDataValue("Omschrijving", text2.getText());
					d.Update("status");

					d.Where = "";

					tb = d.SelectDT("Status");
				...
				/*
				 * DBMySQL d = new DBMySQL(); try { f.remove(js);
				 * d.addWhere("ArtikelID", "4"); tb = d.SelectDT("Artikelen");
				 * js = new JScrollPane(tb); js.setBounds(0, 100, 490, 300);
				 * 
				 * f.getContentPane().add(js); } catch (Exception e) { }
				 */
			}
